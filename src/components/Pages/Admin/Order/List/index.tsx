...
const OrderListPage = memo(() => {
  ...
  return (
    <Fragment>
      ...
      <Card>
        <OrderFormDialog opened={formOpened} user={current} onComplete={formCallback} onCancel={formCancel} />
          ...
          <Table>
            <TableHead>
              <TableRow>
                ...
                <TableCellSortable paginationParams={params} disabled={loading} onChange={mergeParams} column='user'>
                  Usuário
                </TableCellSortable>
                <TableCellActions>
